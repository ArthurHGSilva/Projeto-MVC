<div class="col-xl-4 col-md-6 mx-auto p-5">
    <div class="card">
        <div class="card-body">
            ...
            <form name="Login" method="POST" action="<?php echo URL?>/produtos/update" class="mt-4">
                ...
                <div class="row">
                    <div class="col">
                        <input type="submit" value="Alterar" class="btn btn-primary" style="padding: 10px 50px">
                    </div>
                </div>
            </form>
        </div>
